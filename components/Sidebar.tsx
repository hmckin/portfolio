...
export default function Sidebar({ activeSection, onNavigate }: SidebarProps) {
  ...
  return (
    <aside
      data-sidebar
      className="fixed left-0 top-0 w-1/2 h-screen bg-cardstock flex flex-col z-50 overflow-hidden"
    >
      <div className="flex flex-col mx-28 my-28 h-full">
        <div className="flex-1 flex flex-col">
          <h1 className="text-3xl font-bold text-text-primary mb-2 tracking-tight">
            Harry McKinney
          </h1>
          <p className="text-[0.95rem] text-text-secondary my-8 leading-relaxed">
            I like solving hard problems and building lean software. 
          </p>
